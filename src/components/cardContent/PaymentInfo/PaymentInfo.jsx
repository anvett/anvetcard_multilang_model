...
const BankInfo = ({
  ...
  const {
    ...
    description: componentDescription = "Haz clic en el logo para ver los datos bancarios",
    descriptionSize: componentDescriptionSize = "text-size-1 sm:text-size-2",
    descriptionColor: componentDescriptionColor = "text-secondary",
  ...
  return (
    <div className={`w-full container mx-auto p-4 py-spacing-3 ${componentBgColor}`}>
      ...
      <h4 className={`text-center pb-spacing-3  ${componentDescriptionColor} ${componentDescriptionSize}`}>
