...
const GallerySlider = ({
  ...
  const {
    width = "w-[85vw] sm:w-[28rem] md:w-[30rem] lg:w-[40rem]",
    height = "h-[85vw] sm:h-96 md:h-[30rem] lg:h-[40rem]",
    rounded = "rounded-xl",
  ...
  return (
    <section className="w-full py-spacing-4 px-4">
      ...
      {/* ✅ Slider */}
      <div className="w-90 flex flex-col justify-center items-center" onClick={handleClick}>
