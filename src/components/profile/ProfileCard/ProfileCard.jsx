...
//     // 🆕 Opciones del botón Compartir
//     shareLabel = "Compartir",
//     shareMessage = "Te comparto la tarjeta digital de la Dra. Karen Freire 🦷✨",
//     // Usa el website del perfil si existe; si no, el subdominio de la instancia
//     shareUrl = profile.website || "https://karenfreire.anvetcard.com",
//   } = buttonOptions;
...
//                 width={width}
//                 height={height}
//                 className={`object-fill w-[300px] h-[420px] sm:w-[400px] sm:h-[550px] ${imageRounded}`}
//               />
//             )}
//           </motion.div>
//         </figure>
...
const ProfileCard = ({
  ...
  const shareUrl = encodeURIComponent("https://karenfreire.anvetcard.com");
  const whatsappShareLink = `https://wa.me/?text=${shareMessage}%20${shareUrl}`;
