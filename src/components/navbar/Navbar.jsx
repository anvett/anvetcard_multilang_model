...
const Navbar = ({
  ...
  return (
    <div className={`navbar ${bgColor} ${textColor} px-spacing-5 py-2 flex items-center justify-between  gap-spacing-2 relative z-50 border-b-2 ${borderColor}`}>
      <div className="flex justify-between gap-spacing-2 items-center w-80">
        ...
        {/* Logo */}
        <Image className="justify-center shadow-sm shadow-secondary" src={logoSrc} width={90} height={90} alt="Logo" suppressHydrationWarning />
      </div>
